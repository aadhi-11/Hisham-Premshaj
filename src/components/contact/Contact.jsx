...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "North Delhi, India 110009",
  },
  {
    icon: faEnvelope,
    title: "Email",
    description: "hishampremshaj@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91 98475 62227",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I'm available for discussing your ideas. Drop me a line if you have any idea.
              </p>
            </div>
